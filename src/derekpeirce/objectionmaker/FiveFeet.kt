...
val hideousLaughter = keyword("Tasha's hideous laughter")
val prone = keyword("prone")
val eldritchBlast = keyword("eldritch blast")
val maddeningHex = keyword("Maddening Hex")
val wisdomSavingThrow = keyword("Wisdom saving throw")
val sleep = keyword("sleep")

// https://www.reddit.com/r/DMDadJokes/comments/nd2ors/hes_not_wrong/
...
fun main() {
    ...
    makeTrial() {
        val judge = Judge()
        val phoenix = Phoenix()
        val moe = Moe(background = Background.PROSECUTION)
        val regina = Regina()
        ...
        playMusic(Music.CIRCUS) {
            ...
            moe("He fails!\t At least someone has a sense of humor here!\t He is now $incapacitated and $prone!")
            regina.happy("I thought it was funny,\t Uncle Moe!")
            moe("For that,\t you get $bardicInspiration.")
            judge.positive("\t And now it's his turn.\t He spends his movement crawling ${value(15)} feet towards you,\t Regina,\t laughing like a maniac the entire time. $dieRoll He fails again.\t Regina,\t you're up.")
            regina.happy("Yay!\t I hit him with $eldritchBlast!")
        }
        playMusic(Music.SUSPENSE) {
            judge.negative("You will have disadvantage because he's $prone and you're making a ranged attack!")
            moe.point("But he's also $incapacitated,\t so I think that means you also have advantage.")
            judge.negative.holdIt("While other conditions that also include the $incapacitated condition,\t like $stunned, grant advantage on attack rolls against the creature,\t the $incapacitated condition itself does not.")
            ...
            phoenix.point.objection("You have disadvantage if you're within 5 feet of a hostile creature that can see you and isn't $incapacitated!")
            ...
            judge.positive("The count's mirth is replaced with anger.\t He's no longer $incapacitated,\t so you have disadvantage,\t canceling out your advantage.")
        ...
        playMusic(Music.CROSS_EXAMINING) {
            judge.negative("But that doesn't mean this fight is over!\t The priestess of Lolth is up next.")
            regina.cry("Oh no!\t I'm out of movement,\t if she heals him he can hit me.")
            regina.point(
